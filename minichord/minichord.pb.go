...
type RegistrationResponse struct {
	...
	Result int32  `protobuf:"fixed32,1,opt,name=Result,proto3" json:"Result,omitempty"`
...
func (x *Deregistration) GetNode() *Node {
	if x != nil {
		return x.Node
	}
	return nil
...
type NodeRegistry struct {
	...
	NR    uint32  `protobuf:"fixed32,1,opt,name=NR,proto3" json:"NR,omitempty"`
	Peers []*Node `protobuf:"bytes,2,rep,name=Peers,proto3" json:"Peers,omitempty"`
	NoIds uint32  `protobuf:"fixed32,3,opt,name=NoIds,proto3" json:"NoIds,omitempty"`
	Ids   []int32 `protobuf:"fixed32,4,rep,packed,name=Ids,proto3" json:"Ids,omitempty"`
}
...
func (x *NodeRegistry) GetPeers() []*Node {
	if x != nil {
		return x.Peers
	}
	return nil
...
type InitiateTask struct {
	...
	Packets uint32 `protobuf:"fixed32,1,opt,name=Packets,proto3" json:"Packets,omitempty"`
}
...
type TrafficSummary struct {
	...
	Id            int32  `protobuf:"fixed32,1,opt,name=Id,proto3" json:"Id,omitempty"`
	Sent          uint32 `protobuf:"fixed32,2,opt,name=Sent,proto3" json:"Sent,omitempty"`
	Relayed       uint32 `protobuf:"fixed32,3,opt,name=Relayed,proto3" json:"Relayed,omitempty"`
	Received      uint32 `protobuf:"fixed32,4,opt,name=Received,proto3" json:"Received,omitempty"`
	TotalSent     int64  `protobuf:"fixed64,5,opt,name=TotalSent,proto3" json:"TotalSent,omitempty"`
	TotalReceived int64  `protobuf:"fixed64,6,opt,name=TotalReceived,proto3" json:"TotalReceived,omitempty"`
}
...
func (x *MiniChord) Reset() {
	*x = MiniChord{}
	if protoimpl.UnsafeEnabled {
		mi := &file_minichord_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MiniChord) Descriptor() ([]byte, []int) {
	return file_minichord_proto_rawDescGZIP(), []int{12}
}
...
type MiniChord_RegistrationResponse struct {
	RegistrationResponse *RegistrationResponse `protobuf:"bytes,2,opt,name=registrationResponse,proto3,oneof"`
}

type MiniChord_Deregistration struct {
	Deregistration *Deregistration `protobuf:"bytes,3,opt,name=deregistration,proto3,oneof"`
}

type MiniChord_DeregistrationResponse struct {
	DeregistrationResponse *DeregistrationResponse `protobuf:"bytes,4,opt,name=deregistrationResponse,proto3,oneof"`
}

type MiniChord_NodeRegistry struct {
	NodeRegistry *NodeRegistry `protobuf:"bytes,5,opt,name=nodeRegistry,proto3,oneof"`
}

type MiniChord_NodeRegistryResponse struct {
	NodeRegistryResponse *NodeRegistryResponse `protobuf:"bytes,6,opt,name=nodeRegistryResponse,proto3,oneof"`
}

type MiniChord_InitiateTask struct {
	InitiateTask *InitiateTask `protobuf:"bytes,7,opt,name=initiateTask,proto3,oneof"`
}

type MiniChord_NodeData struct {
	NodeData *NodeData `protobuf:"bytes,8,opt,name=nodeData,proto3,oneof"`
}

type MiniChord_TaskFinished struct {
	TaskFinished *TaskFinished `protobuf:"bytes,9,opt,name=taskFinished,proto3,oneof"`
}

type MiniChord_RequestTrafficSummary struct {
	RequestTrafficSummary *RequestTrafficSummary `protobuf:"bytes,10,opt,name=requestTrafficSummary,proto3,oneof"`
}

type MiniChord_ReportTrafficSummary struct {
	ReportTrafficSummary *TrafficSummary `protobuf:"bytes,11,opt,name=reportTrafficSummary,proto3,oneof"`
}
...
var file_minichord_proto_rawDesc = []byte{
	...
	,
	...
	,
}
...
var file_minichord_proto_goTypes = []interface{}{
	...
	(*Node)(nil),                   // 2: minichord.Node
	(*Deregistration)(nil),         // 3: minichord.Deregistration
	(*DeregistrationResponse)(nil), // 4: minichord.DeregistrationResponse
	(*NodeRegistry)(nil),           // 5: minichord.NodeRegistry
	(*NodeRegistryResponse)(nil),   // 6: minichord.NodeRegistryResponse
	(*InitiateTask)(nil),           // 7: minichord.InitiateTask
	(*NodeData)(nil),               // 8: minichord.NodeData
	(*TaskFinished)(nil),           // 9: minichord.TaskFinished
	(*RequestTrafficSummary)(nil),  // 10: minichord.RequestTrafficSummary
	(*TrafficSummary)(nil),         // 11: minichord.TrafficSummary
	(*MiniChord)(nil),              // 12: minichord.MiniChord
}
var file_minichord_proto_depIdxs = []int32{
	2,  // 0: minichord.Deregistration.node:type_name -> minichord.Node
	2,  // 1: minichord.NodeRegistry.Peers:type_name -> minichord.Node
	0,  // 2: minichord.MiniChord.registration:type_name -> minichord.Registration
	1,  // 3: minichord.MiniChord.registrationResponse:type_name -> minichord.RegistrationResponse
	3,  // 4: minichord.MiniChord.deregistration:type_name -> minichord.Deregistration
	4,  // 5: minichord.MiniChord.deregistrationResponse:type_name -> minichord.DeregistrationResponse
	5,  // 6: minichord.MiniChord.nodeRegistry:type_name -> minichord.NodeRegistry
	6,  // 7: minichord.MiniChord.nodeRegistryResponse:type_name -> minichord.NodeRegistryResponse
	7,  // 8: minichord.MiniChord.initiateTask:type_name -> minichord.InitiateTask
	8,  // 9: minichord.MiniChord.nodeData:type_name -> minichord.NodeData
	9,  // 10: minichord.MiniChord.taskFinished:type_name -> minichord.TaskFinished
	10, // 11: minichord.MiniChord.requestTrafficSummary:type_name -> minichord.RequestTrafficSummary
	11, // 12: minichord.MiniChord.reportTrafficSummary:type_name -> minichord.TrafficSummary
...
func file_minichord_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_minichord_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
	...
	file_minichord_proto_msgTypes[12].OneofWrappers = []interface{}{
